<%-- 
    Document   : signup.jsp
    Created on : Jan 21, 2024, 11:03:07 AM
    Author     : sodok
--%>
                        ...
                        <div id="first">
                            <div class="myform form ">
                                ...
                                <form action="adminAddUser" method="post">
                                    ...
                                    <div class="col-md-12 text-center ">
                                        <h6 style="color:red">${addError}</h6>
                                        <h6 style="color:red">${passError}</h6>
                                        <h6 style="color:green">${addSuccess}</h6>
                                        <button type="submit" class=" btn btn-block mybtn btn-primary tx-tfm">Add User</button>
                                    </div>
                                    <div class="col-md-12 ">
                                        <div class="login-or">
                                            <hr class="hr-or">
