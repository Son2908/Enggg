<%-- 
    Document   : place
    Created on : Feb 4, 2024, 10:40:42 AM
    Author     : sodok
--%>
    ...
    <body>
        ...
        <section style="padding: 120px">
            <div class="container">
                ...
                <div style="color: red; font-weight: bold">${notfound}</div>
                    ...
                    <div class="place__column__wrapper col-lg-3">
                        ...
                        <div  style="height: 14rem" class="detailRoom_wrapper">
                            ...
                            <span class="card-text" style="font-size: 15px; color:grey ; float: right; margin-top: 3px" > 
                                <form action="isLikePageSearchController" method="get">

                                    <input  name="isLike" value="true/<%=s.getId()%>/<%=keyword%>" style="display: none"/>
                            ...
                            <span class="card-text" style="font-size: 15px; color:grey ; float: right; margin-top: 3px" > 
                                <form action="isLikePageSearchController" method="get">
                                    ...
                                    <input  name="isLike" value="false/<%=s.getId()%>/<%=keyword%>" style="display: none"/>
                            ...
                            <div class="place__price__wrapper" style="color: #f65e38; padding-left: 6px">
                                ...
                                <span style="color: grey; float: right"><%=s.getStar()%> <i class="fas fa-star" style="color:  rgb(255, 176, 37)"></i></span>
                            </div>
