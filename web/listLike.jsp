<%-- 
    ...
    Created on : Feb 3, 2024, 2:02:03 PM
    Author     : sodok
--%>

<%@page import="model.Room"%>
<%@page import="dal.PlaceDAO"%>
<%@page import="model.LikeRoom"%>
            ...
            <div class="container">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <%
                            ArrayList<LikeRoom> Histories = (ArrayList<LikeRoom>) request.getAttribute("history");
                            PlaceDAO pDao = new PlaceDAO();
                        %> 


                        <% for (LikeRoom s : Histories) {
                        %>
                        ...
                        <tr>
                            ...
                            <td>
                                <a  class="btn btn-sm" type="submit" href="roomDetailController?id=<%=s.getIdRoom()%>" style="background-color: #03a9f4; color: white;">Đặt Phòng
                                </a>
                                <a  class="btn btn-sm" type="submit" href="cancelIdLikeList?id=<%=s.getIdRoom()%>" style="background-color: #f65e38; color: white;">Bỏ Thích
                                </a>
