<%-- 
    Document   : admin
    Created on : Jan 20, 2024, 10:23:49 AM
    Author     : sodok
--%>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavId">
                        ...
                        <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                            <li class="nav-item active">
                                <a class="nav-link" href="adminInformation.jsp" style="color: #f65e38">Admin </a>
                            </li>
                            <li class="nav-item active">
                ...
                <div class="row">
                    ...
                    <div class ="col-lg-6" style="margin-top:10px ; margin-left: 20px">
                        <div class="card">
                            ...
                            <div class="mapouter"><div class="gmap_canvas"><iframe width="823" height="319" id="gmap_canvas" src="https://maps.google.com/maps?q=FPT%20university&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://123movies-to.org">123movies</a></div><style>.mapouter{
                                            position:relative;
                                            text-align:right;
                                            height:319px;
                                            width:823px;
