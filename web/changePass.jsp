<%-- 
    Document   : changePassIfForgot
    Created on : Mar 6, 2024, 2:24:04 AM
    Author     : sodok
--%>
                            ...
                            <div class="myform form ">
                                ...
                                <form action="./resetPasswordController" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="newPass" id="password" class="form-control" aria-describedby="emailHelp" placeholder="Enter New Password" required/><br>
                                        <input type="password" name="confirmNewPass" id="confirmPassword" class="form-control" aria-describedby="emailHelp" placeholder="Confirm New Password" required/>                                    </div>
                                    <h6 style="color:green">${changeSuccess}</h6>
                                    <h6 style="color:red">${changeError}</h6>
                                    <div class="col-md-12 text-center ">
