<%-- 
    ...
    Created on : Jan 28, 2024, 10:42:27 AM
    Author     : sodok
--%>
...
<html>
    ...
    <body>
        ...
        <section style="padding-top: 100px;  background-color: #F4F4F4; border-radius : 34px ; padding-bottom: 50px;">
            <div class="container">
                <div style="color: green; font-weight: bold; font-size: 30px; margin-bottom: 30px; font-family: sans-serif">${success}</div>
                <div class="row">
                    <div class="col-lg-8">
                        <h6 style="font-size: 20px; font-weight: 700;">${dayBetween} đêm tại ${bookingRoom.getRoomName()}</h6>
                        ...
                        <a  class="btn" type="submit" href="paymentController?id=${bookingRoom.getId()}&quantity=${dayBetween}&dobBefore=${checkin}&dobAfter=${checkout}" style="background-color: #f65e38; color: white; margin-top: 20px;">Đặt phòng
                        </a>
