<%-- 
    ...
    Created on : Feb 2, 2024, 2:02:03 PM
    Author     : sodok
--%>
            ...
            <div class="container">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <%
                            ArrayList<Booking> Histories = (ArrayList<Booking>) request.getAttribute("history");
                        ...
                        <tr>
                            ...
                            <td><a  class="btn btn-sm" type="submit" href="cancelBookingController?id=<%=s.getIdBooking()%>" style="background-color: #f65e38; color: white;">Huỷ Phòng
                                </a></td>
                        </tr>
                        ...
                        <tr class="thead-light">
                            ...
                            <th scope="col"><%= String.format("%,.0f", totalAmount) %> đ</th>
                            <th scope="col"></th>
                        </tr>
                    </tbody>
                </table>
